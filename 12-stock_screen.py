# -*- coding: utf-8 -*-
"""
Created on Tue May 28 23:19:34 2024

@author: Yunus
"""

"""
This script is designed to perform stock screening based on specific technical criteria using the TradingView data. 
It defines six different screening functions, each with a unique set of conditions to identify stocks that meet certain trading signals.
"""
...
# Get the results from all screeners
Tarama1 = Tarama_1()
Tarama2 = Tarama_2()
Tarama3 = Tarama_3()
Tarama4 = Tarama_4()
...
print_results('TARAMA 1 SONUÇLARI', Tarama1)
print_results('TARAMA 2 SONUÇLARI', Tarama2)
print_results('TARAMA 3 SONUÇLARI', Tarama3)
print_results('TARAMA 4 SONUÇLARI', Tarama4)
print_results('TARAMA 5 SONUÇLARI', Tarama5)
print_results('TARAMA 6 SONUÇLARI', Tarama6)
