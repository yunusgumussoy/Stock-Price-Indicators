# -*- coding: utf-8 -*-
"""
Created on Tue May 28 15:22:58 2024

@author: Yunus
"""

"""
This Python script is designed to fetch stock data from the Istanbul Stock Exchange (BIST) using the tvDatafeed library, 
calculate the Tillson T3 indicator, and identify buy and sell signals based on the indicator.
"""
...
# Initialize TvDatafeed and get all symbols from the Turkey market
tv = TvDatafeed()
Hisseler = get_all_symbols(market='turkey')
Hisseler = [symbol.replace('BIST:', '') for symbol in Hisseler]
Hisseler = sorted(Hisseler)

# DataFrame for storing signals
...
for i in range(len(Hisseler)):
    try:
        ...
        Tillson = TillsonT3(data, 14, 0.7, 2)  # Adjusted parameters for Tillson T3
        ...
        Stats = bt.run()
        Signals = Tillson.tail(2).reset_index()
