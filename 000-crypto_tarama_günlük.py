# -*- coding: utf-8 -*-
"""
Created on Thu Jun  6 13:55:45 2024
...
def Tarama_1():
    ...
    MACD Sinyal < 0
    Taramasıdır.
    #RSI 30 seviyesinin üzerinde al verirken Macd 0 'ın altında al tarama
    """
...
def Tarama_2():
    ...
    Taramasıdır.
    #Alternatif Düşeni kıran taramasa olarak da bilinir.
    """
    Tarama = (Query().set_markets('crypto')
                .select('name', 'change','close','volume','Perf.W')
                .where(
...
def Tarama_3():
    ...
    Taramasıdır.
    #Swint Trade 2 nolu stratejisine uyan taramasa olarakda bilinir.
    """
    Tarama = (Query().set_markets('crypto')
                .select('name', 'change','close','volume','Perf.W')
                .where(
