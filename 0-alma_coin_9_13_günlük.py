# -*- coding: utf-8 -*-
"""
Created on Sun Jun 23 14:48:09 2024
...
import wget
url = 'https://raw.githubusercontent.com/Onuragdaci/Stock_Indicators/main/StockIndicators.py'
StockIndicators = wget.download(url)
...
for i in range(0,len(Coinler)):
    try:
        data = SI.TVGet(Coinler[i],'BINANCE','1D',100)
